...
// car_info = (id,from,to,speed,planTime, priority, preset)
car::car(string car_info) {
    ...
    this->whether_priority = info_val[5];
...
// return whether priority
int car::get_whether_priority() const {
    return this->whether_priority;
}

// return whether preset
